...
const DevelopPlugins = [
  ...
  entrypointHashmanifest({ manifestName: "./racelandshop_frontend/manifest.json" }),
];
...
function writeEntrypoint() {
  const entrypointManifest = require(path.resolve("./racelandshop_frontend/manifest.json"));
  fs.writeFileSync(
    path.resolve("./racelandshop_frontend/entrypoint.js"),
    `
try {
  new Function("import('/racelandshopfiles/frontend/${entrypointManifest["./src/main.ts"]}')")();
} catch (err) {
  var el = document.createElement('script');
  el.src = '/racelandshopfiles/frontend/${entrypointManifest["./src/main.ts"]}';

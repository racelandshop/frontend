...
export const racelandshopLinkStyle = css`
  a {
...
export const racelandshopButtonStyle = css`
  mwc-button[raised] {
    border-radius: 10px;
  }
`;

export const racelandshopIconStyle = css`
  paper-menu-button,
  ha-icon {
...
`;
export const racelandshopStyleDialog = [haStyleDialog, css``];
